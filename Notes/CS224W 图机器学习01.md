...
- **图的其他类型**：
    ...
    - **同构图 VS 异构图**
        ...
        <img src="https://gitee.com/shenhao-stu/picgo/raw/master/DataWhale/image-20211208175520842.png" style="zoom: 50%;" />
    
        异构图中，节点的种类和连接关系有多种类型。比如：学术网络
    
        <img src="https://gitee.com/shenhao-stu/picgo/raw/master/DataWhale/image-20211208175440834.png" style="zoom:50%;" />

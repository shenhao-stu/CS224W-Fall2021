...
<img src="doc_imgs/ch2/ch2.0_1.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch2/ch2.0_2.png" style="zoom:33%;" />

**目标**：运用高效的任务独立型特征学习方式进行图机器学习。

如果我们在独立节点级别执行该操作，我们想要模型学会如果讲图上的一个节点 $u$ 映射到 $d$ 维空间。而这个 $d$ 维向量称为特征表示。

<img src="doc_imgs/ch2/ch2.0_3.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch2/ch2.1.1.png" style="zoom: 33%;" />
...
<img src="doc_imgs/ch2/ch2.1.2.png" style="zoom: 33%;" />
...
<img src="doc_imgs/ch2/ch2.1.4.1.png" style="zoom:50%;" />
...
$$
<img src="doc_imgs/ch2/ch2.1.4.3.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch2/ch2.1.5.1.png" style="zoom: 33%;" />
...
<img src="doc_imgs/ch2/ch2.1.5.2_1.png" style="zoom:33%;" />

我们对此进行参数化：

<img src="doc_imgs/ch2/ch2.1.5.2_2.png" style="zoom:33%;" />
...
![](doc_imgs/ch2/ch2.2.2.1.png)

#### 2.2.2.2 游走增长的速度

匿名游走随长度呈指数增长

![](doc_imgs/ch2/ch2.2.2.2.png)
...
<img src="doc_imgs/ch2/ch2.2.2.6_3.png" style="zoom: 50%;" />
...
<img src="doc_imgs/ch2/ch2.3.png" style="zoom: 33%;" />
...
<img src="doc_imgs/ch2/ch2.3.1.png" style="zoom:33%;" />
...
$$
<img src="doc_imgs/ch2/ch2.3.2.1_1.png" style="zoom: 50%;" />
...
<img src="doc_imgs/ch2/ch2.3.2.1_2.png" style="zoom:33%;" />
...
- Power iteration
  ...
  - 例子：
    ...
    <img src="doc_imgs/ch2/ch2.3.3_1.png" style="zoom:33%;" />

- 问题在于：

  - 有一些页面时dead end，没有跳转到其他网页的出链接，这可能会导致“泄漏”

    <img src="doc_imgs/ch2/ch2.3.3_2.png" style="zoom:33%;" />

  - Spider-Trap问题：所有的外部链接都在一个组内，即随机游走会陷入一个循环中

    <img src="doc_imgs/ch2/ch2.3.3_3.png" style="zoom:33%;" />
...
- 解决方法：
  ...
  - 对于dead end问题，可以重新调整矩阵M中的内容：
    ...
    <img src="doc_imgs/ch2/ch2.3.3_4.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch2/ch2.3.3_5.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch2/ch2.3.5.2.png" style="zoom:50%;" />

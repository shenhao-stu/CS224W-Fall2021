...
- 为什么图深度学习相比CV，NLP更难？
  ...
  - 相比于图像和文本，图结构的大小比较随意且拓扑结构复杂（没有像网格那样的空间局部性）。
    ...
    <img src="doc_imgs/ch1/ch1.0.1_2.png" style="zoom:25%;" />
...
- 图学习应用：
  ...
  <img src="doc_imgs/ch1/ch1.0.1_4.png" style="zoom:50%;" />

### 1.0.2 图的表示方式

#### 1.0.2.1 图的组成

<img src="doc_imgs/ch1/ch1.0.2.1.png" style="zoom: 25%;" />
...
<img src="doc_imgs/ch1/ch1.0.2.2_1.png" style="zoom: 33%;" />
...
- **图的其他类型**：
    - **无权图 VS 加权图**
        <img src="doc_imgs/ch1/ch1.0.2.2_2.png" style="zoom:25%;" />
        
    - **自循环、多边图**
        <img src="doc_imgs/ch1/ch1.0.2.2_3.png" style="zoom:25%;" />
        
    - **同构图 VS 异构图**
    
        同构图中，节点的种类和连接关系都只有一种。比如：人际关系网络
    
        <img src="doc_imgs/ch1/ch1.0.2.2_4.png" style="zoom: 50%;" />
    
        异构图中，节点的种类和连接关系有多种类型。比如：学术网络
    
        <img src="doc_imgs/ch1/ch1.0.2.2_5.png" style="zoom:50%;" />
...
<img src="doc_imgs/ch1/ch1.0.2.3_1.png" style="zoom:25%;" />

- 图可以用**邻接列表**来表示，这种表示方式只保留了有边的节点的情况，而舍去了稀疏的大部分内容，节约了存储空间。

<img src="doc_imgs/ch1/ch1.0.2.3_2.png" style="zoom: 25%;" />
...
<img src="doc_imgs/ch1/ch1.1.1.png" style="zoom: 50%;" />
...
<img src="doc_imgs/ch1/ch1.1.1.1.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch1/ch1.1.1.2_1.png" style="zoom: 33%;" />
...
c_v=\frac 1 {\sum_{u\not=v}l_{uv}}
$$
<img src="doc_imgs/ch1/ch1.1.1.2_2.png" style="zoom: 33%;" />

#### 1.1.1.3 clustering coefficient
...
<img src="doc_imgs/ch1/ch1.1.1.3.png" style="zoom: 33%;" />
...
<img src="doc_imgs/ch1/ch1.1.1.4_1.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch1/ch1.1.1.4_3.png" style="zoom:33%;" />
...
<img src="doc_imgs/ch1/ch1.1.2.2_2.png" style="zoom:33%;" />
...
![](doc_imgs/ch1/ch1.1.2.3_1.png)

经过 k 步迭代的颜色细化后，WL内核对给定颜色的节点数量进行计数。因此，在这个例子中，我们进行了三次迭代，所以我们有13种的不同颜色。

<img src="doc_imgs/ch1/ch1.1.2.3_2.png" style="zoom:50%;" />

Weisfeiler-Lehman图核就是拿这两个特征描述向量的数量积作为两个图相似性的返回值。

<img src="doc_imgs/ch1/ch1.1.2.3_3.png" style="zoom:33%;" />
